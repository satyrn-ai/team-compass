...
This page describes the team structure that we use in the Satyrn.ai community, as well as how you can get involved.

!!! note "Contribute and join 💗"

    For more information about how you can contribute to the team, see [our contribution guide]().
...
1. **"Watch" the [team compass repository](https://github.com/satyrn-ai/team-compass)**
...
1. **Semi-regularly attend team meetings**. You can find a calendar of upcoming
   meetings [on the team meetings page]().
...
1. **Let us know if you'll be unavailable** or out of town for an extended period
   ...
   To do so, [open an issue in the team-compass](https://github.com/satyrn-ai/team-compass/issues/new).
...
Satyrn.ai is organized into a few teams with varying levels of responsibility and expectations:

### Satyrn.ai Contributors
...
Anybody that has made ongoing or significant contributions to the project is welcome to join the Satyrn.ai Contributors team.
...
- Be an advocate for the Satyrn.ai project to others.

Contributors are added by Organizers, who do so by adding a GitHub username to the [`satyrn-ai-team`]() team on GitHub.
...
The organizerss are stewards and leaders of the Satyrn.ai community.
They ensure that our repositories and collaborative spaces are healthy, inclusive, and productive.

#### Expectations and responsibilities

Organizers commit a larger part of their time stewarding our projects and doing the kinds of things that casual or infrequent contributors do not do.
This may be focused on a subset of the Satyrn.ai organization (e.g., a specific repository or communication space).

For example:

- **Watch issues**. Monitor and provide helpful responses to issues in one or more repositories.
- **Respond on the Discord**. Monitor Discord and provide helpful responses.
...
Organizers generally have heightened privileges (e.g., "Moderator" privileges in a forum, or "Administrator" privileges on a repository).
They also inherit all responsibilities Satyrn.ai Contributors team.

#### How to join

Organizers may be added by any other organizers.
To add a new organizer a current organizer should recommend their addition via [issues in our Team Compass](https://github.com/satyrn-ai/team-compass), or via private communications channels.
If there are no objections to adding a new organizer, add them to [our list of organizers](./index.md).

#### Team size

There is no limit to the number of maintainers that may exist in the Satyrn.ai Project. We hope to have a large and growing pool of regularly-engaged maintainers.

Our goal is to have at least two maintainers for any project within the Satyrn.ai community.
...
There is no limit to the number of Web team members.
...
There is no limit to the number of Engine team members.
...
to be inactive by making a pull request to the [team membership database]().

Any team members that step down are considered "inactive".
This means they no longer commit to the responsibilities of their previous team, but they retain their Satyrn.ai Team Membership status for life.

We keep a record of any inactive team members for the team in which they previously served.
This is both to recognize their contribution, and to have a reference in case they wish to [become active again]().
